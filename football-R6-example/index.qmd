...
closely resemble the class system in Python or Julia, and to a somewhat
lesser extent Java, C++, and other compiled languages that natively
...
classes to represent some other system of interest within their research
program, personal hobbies, or something else.
...
the world and their behaviors. `socmod` uses
